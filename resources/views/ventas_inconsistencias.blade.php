                        ...
                        <div class="table">
                            <div class="table-row-group flex">
                                ...
                                <div class="table-row">
                                    ...
                                    <div class="table-cell border-l border-b border-r border-gray-300 font-ligth {{$color?'bg-gray-100':'bg-white'}} text-gray-700 py-1 px-2 mx-2 text-sm">{{$registro->dn}}<br>{{$registro->tipo}}</div>
